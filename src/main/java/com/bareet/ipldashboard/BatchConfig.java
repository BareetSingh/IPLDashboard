package com.bareet.ipldashboard;

import javax.sql.DataSource;

import com.bareet.ipldashboard.data.JobCompletionNotificationListener;
import com.bareet.ipldashboard.data.MatchDataProcessor;
import com.bareet.ipldashboard.data.MatchInput;
import com.bareet.ipldashboard.model.Match;
...
public class BatchConfig {
    ...
    private final String[] fieldsName = new String[] { "id", "city", "date", "player_of_match", "venue","neutral_venue",
    ...
    public FlatFileItemReader<MatchInput> reader() {
        return new FlatFileItemReaderBuilder<MatchInput>().name("MatchItemReader")
                .resource(new ClassPathResource("data.csv")).delimited().names(fieldsName)
